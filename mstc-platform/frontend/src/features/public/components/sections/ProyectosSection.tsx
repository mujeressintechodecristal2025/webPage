...
const PROJECTS = [
  ...
  },
  {
    ...
    description: 'Desarrollo del ser: promovemos el crecimiento sano del individuo, capacitando y acompañando en el proceso de salud mental, fortaleciendo la autoestima y las habilidades socioemocionales.',
  ...
  },
  {
    ...
    description: 'Promovemos programas de emprendimiento empresarial generando estrategias psicosociales para mitigar la desigualdad tanto emocional como laboral, acompañando a las mujeres en su camino al éxito.',
