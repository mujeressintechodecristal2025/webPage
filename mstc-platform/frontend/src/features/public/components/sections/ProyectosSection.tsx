...
const PROJECTS = [
  {
    id: 1,
    phase: 'Activo · 3 meses',
    name: 'Mujer Emprende',
    description: 'Programa de diseño de modas que forma a mujeres en habilidades técnicas de confección, patronaje y diseño, brindándoles herramientas para crear sus propios emprendimientos en la industria textil.',
  ...
  },
  {
    id: 2,
    phase: 'Activo · 3 meses',
    name: 'Capacitaciones Psicosociales',
    description: 'Desarrollo del ser: promovemos el desarrollo sano del individuo capacitando y acompañando en el proceso de salud mental, fortaleciendo la autoestima y las habilidades socioemocionales.',
  ...
  },
  {
    ...
    name: 'Estrategias para Emprendedores',
    description: 'Promovemos programas de emprendimiento empresarial generando estrategias psicosociales para mitigar la desigualdad tanto emocional como laboralmente, acompañando a las mujeres en su camino al éxito.',
